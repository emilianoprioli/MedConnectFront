...
export default function Navbar() {
  ...
  const logoutGoogle = () => {
    //window.open("http://localhost:3001auth/logout", "_self");
    window.open(
      "http://localhost:3001auth/logout",
      "_self"
    );
  };
  const logoutLocal = () => {
    //window.open("http://localhost:3001auth/logoutLocal", "_self");
    window.open(
      "http://localhost:3001auth/logoutLocal",
      "_self"
    );
  };
  const onClickFunc = () => {
  ...
  useEffect(() => {
    fetch(
      "http://localhost:3001auth/login/success",
      {
        method: "GET",
        credentials: "include",
        headers: {
    ...
    fetch(
      "http://localhost:3001auth/loginn/success",
      {
        method: "GET",
        credentials: "include",
        headers: {
