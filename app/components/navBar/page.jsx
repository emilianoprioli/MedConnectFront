...
<<<<<<< HEAD
      {logStatus.userStatus ? <Link href="/user"><button className={styles.button_user} style={{color:"white"}}>{`${logStatus.userStatus.first_name} ${logStatus.userStatus.last_name}`}</button></Link>: <Link as={UserLogin.route} href={UserLogin.route}>
