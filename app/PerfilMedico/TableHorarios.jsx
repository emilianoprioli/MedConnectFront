...
export default function TableHorarios({filtroHorarios, setSuccessDelete,setErrorDelete,successDelete,errorDelete}) {
  ...
  const columns = [
      ...
      },
      {
        ...
        <Button onClick={()=>handleEliminar(record)} type="dashed">x</Button>}
